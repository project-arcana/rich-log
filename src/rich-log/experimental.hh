...
[[deprecated("the filter is ignored. use a separate logging domain with debug or trace verbosity instead. or a custom logger. (2022-06-25)")]] void set_whitelist_filter(
